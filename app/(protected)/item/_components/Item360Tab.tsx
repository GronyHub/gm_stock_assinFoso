...
// ItemDetailPanel the standalone /stock/[id] route renders), without
// leaving the Grony Cash shell the way that route would. Reuses the items
// list the shell already has loaded rather than fetching its own copy.
export default function Item360Tab({ items }: { items: Item[] }) {
