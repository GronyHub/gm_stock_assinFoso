...
import { Card, Pill, Recommendation, Sparkline, TrendBadge, StalenessBadge, monthLabel, n, fc } from './analyticsShared'
...
// Moved here from the removed "Data" tab's "Items" section -- the two
// heavier cards (item revenue trends, slow-moving stock) keep their own
// dedicated endpoints; the three lighter ones below reuse the same
// all-purpose summary endpoint the other Analytics sections do.
  ...
  return (
    <div>
      ...
      {data && <>
        ...
        <Recommendation>
          This is capital sitting on the shelf, at cost -- not revenue. A group with a large bar here but low sales in the trend list above is capital that could be freed up by reordering less of it.
        </Recommendation>
