...
// Moved here from the removed "Data" tab's "Loss" section -- shown as the
// Analytics view of "Loss by Item", since both are about ranking items by
// their loss numbers, just at different levels of depth.
