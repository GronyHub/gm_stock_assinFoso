...
// - An item's own edit form can set count_excluded (drops it from this list
//   entirely, same as the dormant rule above but permanent/deliberate) or
...
export async function GET() {
  ...
  const rows = await sql`
    ...
    CROSS JOIN LATERAL (
      SELECT COALESCE(i.count_cadence_days, CASE
