...
// already saved on customers, offered back as suggestions so a new
// customer's location gets picked from what's already in use (or added as
// a genuinely new one) instead of a free-typed near-duplicate variant.
