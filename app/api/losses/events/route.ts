...
//
// Loss valuation matches /api/losses/summary: the 4x6 paper chain is valued
// at ₵20 per sheet (packs = packs × sheets-per-pack × ₵20, as papers used for
// passport work but never recorded); everything else at its selling price.
