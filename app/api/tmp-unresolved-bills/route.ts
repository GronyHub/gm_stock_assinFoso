...
export async function GET() {
  ...
  `
  const sources = await sql`SELECT id, canonical_name, product_type, status, source, is_legacy, track_inventory, sellable, purchasable FROM items WHERE source != 'zoho_historical' LIMIT 20`
